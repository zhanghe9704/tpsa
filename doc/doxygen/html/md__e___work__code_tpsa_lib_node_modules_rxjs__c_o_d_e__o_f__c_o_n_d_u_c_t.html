...
<title>cppTPSA: Contributor Covenant Code of Conduct</title>
...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md__e___work__code_tpsa_lib_node_modules_rxjs__c_o_d_e__o_f__c_o_n_d_u_c_t.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
<div class="contents">
<div class="textblock"><h1><a class="anchor" id="autotoc_md2827"></a>
Our Pledge</h1>
...
Enforcement</h1>
<p>Instances of abusive, harassing, or otherwise unacceptable behavior may be reported by contacting Ben Lesh (<a href="#" onclick="location.href='mai'+'lto:'+'ben'+'@b'+'enl'+'es'+'h.c'+'om'; return false;">ben@b<span style="display: none;">.nosp@m.</span>enle<span style="display: none;">.nosp@m.</span>sh.co<span style="display: none;">.nosp@m.</span>m</a>), Tracy Lee (<a href="#" onclick="location.href='mai'+'lto:'+'tra'+'cy'+'@th'+'is'+'dot'+'.c'+'o'; return false;">tracy<span style="display: none;">.nosp@m.</span>@thi<span style="display: none;">.nosp@m.</span>sdot.<span style="display: none;">.nosp@m.</span>co</a>) or OJ Kwon (<a href="#" onclick="location.href='mai'+'lto:'+'kwo'+'n.'+'ohj'+'oo'+'ng@'+'gm'+'ail'+'.c'+'om'; return false;">kwon.<span style="display: none;">.nosp@m.</span>ohjo<span style="display: none;">.nosp@m.</span>ong@g<span style="display: none;">.nosp@m.</span>mail<span style="display: none;">.nosp@m.</span>.com</a>). All complaints will be reviewed and investigated and will result in a response that is deemed necessary and appropriate to the circumstances. The project team is obligated to maintain confidentiality with regard to the reporter of an incident. Further details of specific enforcement policies may be posted separately.</p>
