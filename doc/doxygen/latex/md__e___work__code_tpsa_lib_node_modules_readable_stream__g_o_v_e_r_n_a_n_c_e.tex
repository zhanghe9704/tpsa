...
For the current list of WG members, see the project \href{./README.md\#current-project-team-members}{\texttt{ README.\+md}}.\hypertarget{md__e___work__code_tpsa_lib_node_modules_readable_stream__g_o_v_e_r_n_a_n_c_e_autotoc_md2358}{}\doxysubsection{Collaborators}\label{md__e___work__code_tpsa_lib_node_modules_readable_stream__g_o_v_e_r_n_a_n_c_e_autotoc_md2358}
...
For the current list of Collaborators, see the project \href{./README.md\#members}{\texttt{ README.\+md}}.\hypertarget{md__e___work__code_tpsa_lib_node_modules_readable_stream__g_o_v_e_r_n_a_n_c_e_autotoc_md2359}{}\doxysubsection{WG Membership}\label{md__e___work__code_tpsa_lib_node_modules_readable_stream__g_o_v_e_r_n_a_n_c_e_autotoc_md2359}
...
No more than 1/3 of the WG members may be affiliated with the same employer. If removal or resignation of a WG member, or a change of employment by a WG member, creates a situation where more than 1/3 of the WG membership shares an employer, then the situation must be immediately remedied by the resignation or removal of one or more WG members affiliated with the over-\/represented employer(s).\hypertarget{md__e___work__code_tpsa_lib_node_modules_readable_stream__g_o_v_e_r_n_a_n_c_e_autotoc_md2360}{}\doxysubsection{WG Meetings}\label{md__e___work__code_tpsa_lib_node_modules_readable_stream__g_o_v_e_r_n_a_n_c_e_autotoc_md2360}
...
The moderator is responsible for summarizing the discussion of each agenda item and sends it as a pull request after the meeting.\hypertarget{md__e___work__code_tpsa_lib_node_modules_readable_stream__g_o_v_e_r_n_a_n_c_e_autotoc_md2361}{}\doxysubsection{Consensus Seeking Process}\label{md__e___work__code_tpsa_lib_node_modules_readable_stream__g_o_v_e_r_n_a_n_c_e_autotoc_md2361}
